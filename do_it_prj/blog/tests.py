...
class TestView(TestCase):
    def setUp(self):
        self.client = Client()
        self.user_sola = User.objects.create_user(username='sola', password='sola1234')
        self.user_yongha = User.objects.create_user(username='yongha', password='sola1234')
    ...
    def test_post_list(self):
        ...
        post_001 = Post.objects.create(
            ...
            author=self.user_sola
        )

        post_002 = Post.objects.create(
            title='두번째 포스트입니다.',
            content='1등이 전부는 아니잖아요?',
            author=self.user_yongha
        ...
        self.assertIn(self.user_sola.username.upper(), main_area.text)
        self.assertIn(self.user_yongha.username.upper(), main_area.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_sola.username.upper(), post_area.text)
